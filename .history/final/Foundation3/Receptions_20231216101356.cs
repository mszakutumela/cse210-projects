...
public class Receptions : Events
{
    ...
    public Receptions(string title, string description, string date, string time,  address, string type, string email) : base(title, description, date, time, address, type)
    {
        _rsvpEmail = email;
    }
