...
class Program
{
    static void Main(string[] args)
    {
        ...
        Receptions reception = new("For Time and All Eternity", "Ayanda's Wedding", "05 March 2023", "4:00 pm", $"{receptionAddress}", "Rece" "misszandlovu@gmail.com");
        Console.WriteLine("_________________________________________________________________________________________________");
        ...
        OutDoorGatherings outdoor = new("Free Your Mind Hike", "Word of Wisdom Goal", "16 December 2023", "05:30 am", $"{outdoorAddress}", "30'C");
        Console.WriteLine("_________________________________________________________________________________________________");
