...
class Program
{
    static void Main(string[] args)
    {
        ...
        Lectures lecture = new("For Time and All Eternity", "Ayanda's Wedding", "05 March 2023", "4:00 pm", $"{outdoorAddress}", "Reception", "To Be Announced", 50);
        Console.WriteLine("_________________________________________________________________________________________________");
        ...
        Address address3 = new("50 North Temple", "Salt Lake City", "Utah", "USA", 84150);
        string outdoorAddress = address1.GetFullAddress();
        Lectures lecture = new("Some Lessons on Faith and Fear", "BYU Speeches", "10 May 2008", "12:00 pm", $"{lectureAddress}", "Lecture", "Gregory Clark", 300);
        Console.WriteLine("_________________________________________________________________________________________________");
