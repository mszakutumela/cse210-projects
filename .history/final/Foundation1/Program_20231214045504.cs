...
class Program
{
    static void Main(string[] args)
    {
        ...
        Video video2 = new("New Testament Come Follow Me (1-3 John, Jude) LOVE & LIGHT (Nov 27-Dec 3)", "Steve Scott", 31);
        Comment video2Comment1 = new("Benita Harline", "I absolutely LOVE you guys!!! You spread so much light in this dark world and I am extremely grateful for the great service you give in teaching us every week!!!");
        ...
        Comment video2Comment3 = new("Earl Scoville", "When I see Him I will know Him because I will be like Him !  Wow ! short lesson but full of love , light and the spirit. Thank you. Love you bye ..........");
