...
class Program
{
    static void Main(string[] args)
    {
        ...
        Comment video2Comment2 = new("Ruth Lake", "I love how you break down the lessons, we need more teachers like you at church! You have helped me teach and connect with my teen class in a different way, thank you.");
