...
class Program
{
    static void Main(string[] args)
    {
        ...
        Comment video3Comment2 = new("Charmaine Rawlings", "Thank you my brothers in the gospel for your time, you efforts to help me to understand the gospel’s better, i do value your efforts as it helps me draw closer to my Saviour");
