...
class Program
{
    static void Main(string[] args)
    {
        ...
        Comment video3Comm3ent2 = new("Ruth Lake", "I love the JOY and excitement from Grace and David as they teach us! I makes me excited about learning and keeping gospel principles.");
        Comment video2Comment3 = new("Juli Boyd", "It would be so so cool if you did a timeline like you did for the Old Testament. With pictures!");
