...
class Program
{
    static void Main(string[] args)
    {
        ...
        Comment video2Comment1 = new("Cathy Palmer", " absoluteIly LOVE you guys!!! You spread so much light in this dark world and I am extremely grateful for the great service you give in teaching us every week!!!");
