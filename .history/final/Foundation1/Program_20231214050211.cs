...
class Program
{
    static void Main(string[] args)
    {
        ...
        video2.ListComment(video2Comment3);
         ...
         Video video3 = new("Come Follow Me New Testament (Nov. 13-19)", "Don't Miss This", 69);
        Comment video3Comment1 = new("Cathy Palmer", "'Sticks and stones may break some bones, but words will break a heart.'");
        Comment video3Comment2 = new("Ruth Lake", "I love the JOY and excitement from Grace and David as they teach us! I makes me excited about learning and keeping gospel principles.");
        Comment video3Comment3 = new("Juli Boyd", "It would be so so cool if you did a timeline like you did for the Old Testament. With pictures!");

        video3.ListComment(video2Comment1);
        video3.ListComment(video2Comment2);
        video3.ListComment(video2Comment3);
