...
class Program
{
    static void Main(string[] args)
    {
        ...
        Comment video3Comment2 = new("", "I love the JOY and excitement from Grace and David as they teach us! I makes me excited about learning and keeping gospel principles.");
