...
class Program
{
    static void Main(string[] args)
    {
        ...
        Comment video3Comment3 = new("", "I am so grateful to hear that you’ve come back, a lost sheep! I was one also, returning has made me so very happy. I am excited that you will serve a mission, there’s just nothing like feeling the Spirit and following Jesus.");
