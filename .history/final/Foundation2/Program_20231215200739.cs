...
class Program
{
    static void Main(string[] args)
    {
        ...
        Customer customer3 = new("John Black", address2);

        List<Product> productList3 = new();
        Product hairP3 = new("Nivea Conditioner", "NC105", 15.99, 1);
        Product fruitsP3 = new("Strawberries", "S0003", 5.99, 1);
        Product drinkP3 = New("Mango Juice", "MJ081", 1.99, 1);
