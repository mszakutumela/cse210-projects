...
class Program
{
    static void Main(string[] args)
    {
        ...
        Product hairP = new("Nivea Conditioner", "NC105", 15.99, 1);
        Product fruitsP = new("Strawberries", "S0003", 5.99, 1);
        Product drinkP = New("Mango Juice", "MJ00YYY81", 1.99, 1);

        productList2.Add(hairP);
        productList2.Add(fruitsP);
        productList2.Add(drinkP);
