...
class Program
{
    static void Main(string[] args)
    {
        ...
        Product drinkP1 = ew("Mango Juice", "MJ081", 1.99, 1);
        ...
        // Third Order
        Address address3 = new("High Street 2042", "Oakland", "California", "USA");
        Customer customer3 = new("Tanya Smith", address3);

        List<Product> productList3 = new();
        Product hairP2 = new("Hair Dryer", "HD406", 34.99, 1);
        Product fruitsP2 = new("Bananas", "B0005", 4.99, 1);
        Product drinkP2 = New("Hot Chocolate", "HC052", 2.99, 2);

        productList3.Add(hairP2);
        productList3.Add(fruitsP2);
        productList3.Add(drinkP2);

        Order order3 = new(productList3, customer3);
