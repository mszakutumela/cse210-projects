...
public class Order
{
    ...
    public string GetTotalCost()
    {
        ...
        foreach (Product product in _products)
        {
           double. += product.GetName() + "(" + Convert.ToString(product.GetProductId()) +") - $" + Convert.ToString(product.GetPrice()) + " x " + Convert.ToString(product.GetQuantity()) + " = " + Convert.ToString(product.TotalPrice());
        }
