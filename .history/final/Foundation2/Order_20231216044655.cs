...
public class Order
{
    ...
    public string GetTotalCost()
    {
        ...
        foreach (Product product in _products)
        {
           Console.WriteLine($"{product.GetName()}: {product.GetProductId() + "- $" + Convert.ToString(product.GetPrice()) + " x " + Convert.ToString(product.GetQuantity()) + " = " + Convert.ToString(product.TotalPrice());
        }
