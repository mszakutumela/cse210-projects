...
public class Order
{
    ...
    public string GetTotalCost()
    {
        ...
        foreach (Product product in _products)
        {
           double.TryParse(totalPrice, 0) += product.GetName() + "(" + Convert.ToString(product.GetProductId()) +") - $" + Convert.ToString(product.GetPrice()) + " x " + Convert.ToString(product.GetQuantity()) + " = " + Convert.ToString(product.TotalPrice());
        }
