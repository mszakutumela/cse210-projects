...
public class Order
{
    ...
    public string GetTotalCost()
    {
        ...
        {
           totalPrice = 0;
           totalPrice += product.GetName() + "(" + Convert.ToString(product.GetProductId()) +") - $" + Convert.ToString(product.GetPrice()) + " x " + Convert.ToString(product.GetQuantity()) + " = " + std::to_string(product.TotalPrice());
        }
