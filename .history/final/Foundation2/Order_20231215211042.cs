...
public class Order
{
    ...
    public string GetTotalCost()
    {
        ...
        {
           totalPrice = 0;
           totalPrice += product.GetName() + "(" + std::to_string(product.GetProductId()) +") - $" + std::to_string(product.GetPrice()) + " x " + std::to_string(product.GetQuantity()) + " = " + std::to_stringproduct.TotalPrice();
        }
