...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Third Order
        Address address3 = new("1120 N 850 W St", "Provo", "Utah", "USA");
        Customer customer3 = new("John Black", address3);

        List<Product> productList3 = new();
        Product hairP2 = new("Nivea Conditioner", "NC105", 15.99, 1);
        Product fruitsP2 = new("Strawberries", "S0003", 5.99, 1);
        Product drinkP2 = New("Mango Juice", "MJ081", 1.99, 1);

        productList3.Add(hairP2);
        productList3.Add(fruitsP2);
        productList3.Add(drinkP2);

        Order order3 = new(productList3, customer2);
        Console.WriteLine("Order Number: 2");
        order2.DisplayDetails();
        Console.WriteLine();
    }
