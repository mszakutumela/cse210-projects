...
public class PromptGenerator
{
    ...
    {
        _prompts.Add("How did I see the hand of the Lord in my life today?");_prompts.Add("Write of a time when you were brave? What gave you the courage to be brave?");
