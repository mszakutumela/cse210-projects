...
public class CheckListGoal : Goal
{
    ...
    {
        string line = $"Checklist Goal: {_shortName} | description: {_description} | points: {_points.ToString()} | {_bonusPoints.ToString()} | {_amountCompleted.ToString()} | {_points.ToString()}";
