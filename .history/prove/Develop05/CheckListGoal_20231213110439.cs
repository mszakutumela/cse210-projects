...
public class CheckListGoal : Goal
{
    ...
    public string ChecklistGoal(string name, string description, int points, int bonusPoints, int amountCompleted, int target)
    {
        _shortName = name;
    ...
    public string ChecklistGoal()
    {
        ...
        return _shortName; _description; _points; _bonusPoints; _amountCompleted; _target;
    }
