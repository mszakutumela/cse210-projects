...
// Step 7: Build a List
// 1. In your Main method, create a list to hold shapes (Hint: The data type should be List<Shape>).
...
// 3. Iterate through the list of shapes. For each one, call and display the GetColor() and GetArea() methods.  
        ...
        Square squareShape = new Square("yellow", 3);
        shapes.Add(squareShape);

        Rectangle rectangleShape = new Rectangle("red", 5, 8);
        shapes.Add(rectangleShape);

        Circle circleShape = new Circle("blue", 6);
        shapes.Add(circleShape);

        foreach (Shape shape in shap )
