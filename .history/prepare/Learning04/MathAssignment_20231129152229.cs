...
public class MathAssignment : Assignment
{
    ...
    public MathAssignment(string studentName, string assignmentTopic, string _textbookSection, string _problems) : base(studentName, assignmentTopic)
    {
        _textbookSection = textbookSection;
        _problems = problems;
    }

    public stringGetHomeworkList()
    {
        homeWorkList = Console.WriteLine($"Section {_textbookSection} Problems {_problems}");
